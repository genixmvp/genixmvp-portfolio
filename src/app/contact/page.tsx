            ...
            <div className="w-full max-w-3xl">
                ...
                {socialLinks.map((link) => (
                    <Link
                        ...
                        aria-label={`Open ${link.name} (external)`}
                        className="group flex items-center gap-3 px-4 py-2 rounded-lg bg-[linear-gradient(90deg,rgba(255, 255, 255, 0),rgba(255,255,255,0.01))] border-white/5 hover:shadow-[0_6px_30px_rgba(124,58,237,0.06)] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[#6b00ff]/40"
                    >
                        ...
                        <span className="font-medium text-slate-100">{link.name}</span>
                    </Link>
                ))}
            </div>

                    <div className="mt-8 text-center text-sm text-slate-300">
                        Or email me at <a href="mailto:genix.mvp@gmail.com" aria-label="Send email to genix.mvp@gmail.com" className="underline hover:text-white/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#6b00ff]/30">genix.mvp@gmail.com</a>
                    </div>
                </div>
            </div>
        </main>
