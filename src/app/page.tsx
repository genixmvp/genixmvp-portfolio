            ...
            <div className="w-full max-w-3xl">
                <div className="bg-gradient-to-br from-[#0b0b10]/60 to-[#0a0a0f]/55  border-white/5 rounded-3xl p-8 sm:p-12 shadow-[0_20px_60px_rgba(2,6,23,0.6)] backdrop-blur-sm">
                    <header className="text-center mb-6">
                        <h1 id="contact-heading" className="text-3xl sm:text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-tr from-[#e7e9ff] via-[#cbd9ff] to-[#bff7ff]">Genix MVP</h1>
                        <p className="mt-3 text-sm sm:text-base text-slate-300 max-w-2xl mx-auto">Carolina Celeste Navarro Aldoradin</p>
                    </header>
